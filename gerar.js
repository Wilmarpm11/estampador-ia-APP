// API para geração de imagens com OpenAI
export default async function handler(req, res) {
  ...
  try {
    ...
    // Gerar duas imagens: uma com o prompt original e outra com uma variação
    const promptVariacao = `${prompt} variação`;
